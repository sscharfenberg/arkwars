...
router.get(
    "/p/:page/s/:sortField/d/:sortDirection",
    catchErrors(manageUsersController.showUsers)
);
...
router.post(
    "/:userid/username",
    catchErrors(manageUsersController.changeUsername)
);
...
router.post(
    "/:userid/avatar/reset",
    catchErrors(manageUsersController.resetAvatar)
);
...
// clear suspension
router.get(
    "/:userid/clearsuspension/:suspensionid",
    catchErrors(manageUsersController.clearUserSuspension)
);

// reset user password
router.post(
    "/:userid/password",
    catchErrors(manageUsersController.resetPassword)
);

// post change email address
router.post(
    "/:userid/email/resend",
    catchErrors(manageUsersController.resendConfirmationEmail)
);

// set email address to confirmed
router.get(
    "/:userid/email/confirm",
    catchErrors(manageUsersController.setEmailConfirmed)
);
